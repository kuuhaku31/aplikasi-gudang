...
(function(e, t) {
	...
	function p(e) {
		...
		return i && 'BODY' !== i && 'HTML' !== i
			? -1 !== [ 'TH', 'TD', 'TABLE' ].indexOf(n.nodeName) && 'static' === t(n, 'position') ? p(n) : n
				...
				computeStyle: {
					...
					fn: function(e, t) {
						...
						if (
							((d =
								'bottom' == c
									? 'HTML' === l.nodeName ? -l.clientHeight + h.bottom : -f.height + h.bottom
									: h.top),
							(s =
								'right' == g
									? 'HTML' === l.nodeName ? -l.clientWidth + h.right : -f.width + h.right
									: h.left),
							a && b)
						)
